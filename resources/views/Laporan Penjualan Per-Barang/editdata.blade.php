        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-validation">
                    <form action="{{ url('/LaporanPenjualanPerBarang/updatedata/' . $transaksiPenjualan->no_faktur) }}" method="POST">
                        @csrf
                                ...
                                <div id="items-container">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-10 offset-lg-2 text-right">
                                            <a href="/LaporanPenjualanPerBarang" class="btn btn-secondary">Kembali</a>
